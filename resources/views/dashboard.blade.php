        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-16">
            ...
            <section class="flex justify-between gap-3 mb-8">
                ...
                <div class="flex self-center gap-3 md:gap-6">
                    <img src="{{ asset('img/avatar.jpeg') }}" class="w-16 h-16 rounded-full md:w-24 md:h-24" alt="">
                    <div>
                        <p class="text-base font-bold md:text-xl text-normal-green">Good Morning, </p>
                        <h3 class="text-2xl font-bold text-gray-900 md:mt-2 md:text-5xl">{{ Auth::user()->name }}</h3>
                    </div>
                </div>
                ...
                <div class="grid justify-end grid-cols-2 gap-3 md:grid-cols-3">
                    <div class="p-3 text-white bg-blue-500 rounded-md lg:p-8">
                        <div class="flex gap-3">
                            <h2 class="text-lg font-extrabold md:text-5xl">0</h2>
                            <div>
                                <p class="text-sm font-bold lg:text-xl">seedballs</p>
                                <p class="text-xs md:text-base">purchased</p>
                            </div>
                        </div>
                    </div>
                    <div class="p-3 text-white bg-green-500 rounded-md lg:p-8">
                        <div class="flex gap-3">
                            ...
                            <div>
                                <p class="text-sm font-bold lg:text-xl">seedballs</p>
                                <p class="text-xs md:text-base">planted</p>
                            </div>
                        </div>
                    </div>
                    <div class="hidden p-3 text-white rounded-md lg:p-8 bg-fuchsia-500 md:block">
                        <div class="flex gap-3">
                            <h2 class="text-lg font-extrabold md:text-5xl">12</h2>
                            <div>
                                <p class="text-sm font-bold lg:text-xl">tons</p>
                                <p class="text-xs md:text-base">CO<sub>2</sub> offset </p>
                            </div>
                        </div>
                    </div>
                </div>
