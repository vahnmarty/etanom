...
<div>
    <section class="max-w-5xl px-8 mx-auto">
        ...
        <div class="min-h-screen py-16">
            ...
            <p>eTanom collects the following information during the registration process: name and email. This information is used for account management and communication purposes.</p>
            ...
            <p>User information is not shared with third parties, except as required by law or with explicit user consent. We do not sell or trade user data.</p>
            ...
            <p>If you have any questions or concerns regarding this privacy policy, please contact us at [hello@etanom.com].</p>
