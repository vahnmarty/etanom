...
@section('content')
    <x-authentication-card>
        ...
        <div class="text-center">
            ...
            <p class="mt-2 text-gray-600">Plant a tree today, nurture a greener tomorrow.</p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}" class="mt-8">
            ...
            <div class="flex justify-center mt-8 divide-x divide-gray-600">

                <div>
                    <p x-show="true" class="pr-8 text-sm">New User? <a href="{{ url('register') }}" class="font-bold underline text-darkgreen">Sign Up!</a></p>
                </div>
